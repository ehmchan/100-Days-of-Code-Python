...
def add_cafe():
    ...
    if form.validate_on_submit():
        with open("cafe-data.csv", "a", encoding="utf8", newline='') as csv_file:
            add_row = csv.writer(csv_file)
            add_row.writerow([form.cafe.data, form.location.data, form.open_time.data, form.closing_time.data, form.coffee_rating.data, form.wifi_rating.data, form.outlet_rating.data])
